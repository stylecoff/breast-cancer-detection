...
if '' in [history_diagnosed, history_biopsies, history_family, symptoms_lumps, symptoms_pain, symptoms_discharge, symptoms_size_change, symptoms_skin_change, screening_mammogram, screening_other_tests]:
